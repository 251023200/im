jQuery.addRoleSelector = (function($) {
	var _htmlUrl="/modules/permissions/html/add-role-selector.html";
	var _element = '#add-role-selector';
	//var _role_url = app.server.auth + '/roles?token='+getToken();
	var _role_url = app.server.auth + '/roles/search-left';
	var _callback = null;
