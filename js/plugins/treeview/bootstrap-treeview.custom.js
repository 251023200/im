...
;(function ($, window, document, undefined) {
	...
	*/
	...
	/**
		Append a node in given tree node
		@param {Object|Number} identifiers - A valid node, node id or array of node identifiers
		@param {optional Object} options
	*/
    ...
    */
	...
	/**
		...
		@param {Object|Number} identifiers - A valid node, node id or array of node identifiers
	*/
	Tree.prototype.removeNode = function (identifiers) {
		this.forEachIdentifier(identifiers, {}, $.proxy(function (node, options) {
			if (node.parentId !== undefined) {
				var parentNode = this.identifyNode(node.parentId);
				$.each(parentNode.nodes, function(i, n) {
					if (n == node) {
